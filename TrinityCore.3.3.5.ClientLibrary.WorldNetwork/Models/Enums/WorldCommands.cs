...
public enum WorldCommands : uint
{
    ...
    SERVER_AUTH_CHALLENGE = 492,
    CLIENT_AUTH_SESSION = 493,
    SERVER_AUTH_RESPONSE = 494,
    ...
    /// <summary> int i1 if (i1 < 0 ) { stop } int int ulong </summary>
    ...
    /// <summary> int flag if (flag & 0x8) { int } else { int int } </summary>
    ...
    SMSG_LFG_OPEN_FROM_GOSSIP =
        1300, // event EVENT_LFG_OPEN_FROM_GOSSIP (opens dungeon finder, probably for outdoor bosses)
